...
let local = '<a href="https://maps.app.goo.gl/uqn7LPWrEzZ5YzVFA" target="_blank"><img src="localizacao.png" alt="">Localização</a>';
let point = '<a href="https://www.santamariadoherval.rs.gov.br/index.php/turismo/pontos-turisticos/570" target="_blank"><img src="camera.png" alt="">Pontos Turísticos</a>'


let evt = '<a href="https://www.santamariadoherval.rs.gov.br/eventos" target="_blank"><img src="calendar.png" alt="">Eventos</a>'
